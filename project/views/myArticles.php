     ...
     <div class="myArt_container">
       ...
       <div class="myArt_body">
         <img class="myArt_img" src="../img/<?= $article->picture; ?>" alt="an image" width="90px">
           ...
           <h5 class="myArt_edit"><a href="<?= ROOT_PATH.'editArticle/'.$article->articleId ?>">edit</a></h5>
           <h5 class="myArt_delete"><a href="<?= ROOT_PATH.'article/'.$article->articleId.'/delete' ?>">delete</a></h5>
       </div>
     </div>
